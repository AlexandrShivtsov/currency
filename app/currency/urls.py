from currency.views import (ContactusCreateView, CurrencyRateListView, CurrencyResponseLog, SourceCreateView,
                            SourceDeleteView, SourceDetailsView, SourceListView, SourceUpdateView, SourceView)
...
urlpatterns = [
    ...
    path('source-list/details-source/<int:pk>/', SourceView.as_view(), name='details-source'),
    path('source-list/details-source-bank/<int:pk>/', SourceDetailsView.as_view(), name='details-source-bank'),
